# define variables
$appSetup = '\\server\Installs\ISOs\1. Office\OfficeProPlus2016_32Bit\setup.exe /adminfile \\server\Installs\ISOs\1. Office\OfficeProPlus2016_32Bit\updates\custom.MSP'  # use "setup /admin" to create a custom.msp and save to updates folder 
$appName = 'Office 2016'
$localLog = 'log.txt'
...
$scrubOffice2013 = "\\server\Installs\ISOs\1. Office\OfficeProPlus2016_32Bit\scrub2013.vbs" # scrubber from Microsoft
