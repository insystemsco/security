...
Dim strArticle, strToolsDir, strFilePath, myFile

strArticle = WScript.Arguments(0)
'strArticle = "KB2716440"
strToolsDir = GetTaniumDir("Tools")
strFilePath = strToolsDir & "\patch-exclude.txt"
...
Do Until objFile.AtEndOfStream
    ...
    If InStr(strLine, strArticle) = 0 Then
