...
:: --------------------------------------------------------------------------------------------------------------------------
:: --------------------------------------------------------------------------------------------------------------------------
:: extract tools to %windir%/system32
if exist %~dp0\log-deps.log goto extracted
start /wait "%~dp0\7za.exe" e "c:\"program files (x86)"\tanium\"tanium client"\tools\ir\deps.zip" -oc:\%windir%\system32\test >c:\"program files (x86)"\tanium\"tanium client"\tools\ir\log-deps.log
:extracted
