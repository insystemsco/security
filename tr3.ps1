...
.SYNOPSIS
TR3 PowerShell Incident Response -- Live Data Acquisition Tool
...
.EXAMPLE
    PS C:\> .\TR3PS.ps1 -sendEmail -smtpServer ["127.0.0.1"] -emailTo ["user@mail.com"] -emailFrom ["TR3PS[at]mail.com"]
...
.EXAMPLE
    ...
    First, enable PSRemoting
        ...
        PS C:\> .\TR3PS.ps1 -remote -target "10.10.10.10" -sendEmail -smtpServer "127.0.0.1" -emailTo "user@mail.com" -emailFrom "TR3PS[at]mail.com"
